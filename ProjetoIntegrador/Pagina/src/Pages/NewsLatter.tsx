      ...
      <div style={{display: overlay? 'flex' : 'none' }} className="overlay">
        ...
        <div className="box-history">
            <div className="text-history">
              ...
              <h5>Mais informações: <a target='_blank'  href="https://resenhacm.com.br/campo-mourao-recebe-campeonato-paranaense-de-judo-neste-final-de-semana-no-ginasio-da-utfpr/">site resenha CM</a>
 </h5> 
