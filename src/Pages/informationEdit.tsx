...
const handleGetInfos = async () => {
  ...
  const handleUpdateInfos = async () => {
    if(activeId < 0){
    await axios.post("https://backendprojectsemeandocampeoes.up.railway.app/users",{nome: nomePessoa, data_de_nascimento: dataNasc, telefone: telefone, responsavel: responsavel, id_centro_de_treinamento: centroDeTreino, id_faixa: faixa, rua: rua, numero: numCasa, bairro: bairro, nome_cidade: nomeCidade})
    setBoxEditMode(false)
    setBoxForCrud(false)
    ...
    await axios.put("https://backendprojectsemeandocampeoes.up.railway.app/users", {id: activeId, nome: nomePessoa, data_de_nascimento: dataNasc, telefone: telefone, responsavel: responsavel, id_centro_de_treinamento: centroDeTreino, id_faixa: faixa, rua: rua, numero: numCasa, bairro: bairro, nome_cidade: nomeCidade})
  ...
  const handleDeleteInfos = async (id : number) => {
    await axios.delete(`https://backendprojectsemeandocampeoes.up.railway.app/users?id=${id}`)
    handleGetInfos()
    setBoxForCrud(false)
